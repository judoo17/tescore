...
$.idealforms.errors = {
  ...
  email: '必须是一个有效的e -mail地址. <em>(xxxxxxxx@xxxx.com)</em>',
  phone: '必须是一个正常的手机号. <em>(xxx-xxx-xxxx)</em>',
  url: '必须是一个正常网站. <em>(e.g. www.qq.com</em>',
  minChar: '最少 <strong>{0}</strong>个字符 .',
  minOption: '最少 <strong>{0}</strong> 个字符.',
  maxChar: '不能多于 <strong>{0}</strong> 个字符.',
  maxOption: '不能多于 <strong>{0}</strong> 个字符.',
  range: '号码必须在 {0} 和 {1}之间.',
  date: '选择一个可用的日期. <em>(e.g. {0})</em>',
  dob: '必须有一个可用的生日日期.',
  exclude: '"{0}" 是不可用的.',
  excludeOption: '{0}',
  equalto: '必须和 <strong>"{0}"</strong>格式一样',
  extension: '文件不正确 <em>(e.g. "{0}")</em>',
  ajaxSuccess: '<strong>{0}</strong> 不可用.',
  ajaxError: '服务器错误请重试...'
